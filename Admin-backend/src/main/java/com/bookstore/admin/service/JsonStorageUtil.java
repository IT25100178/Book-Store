...
public class JsonStorageUtil {
    ...
    public List<Promotion> readPromotions() throws IOException {
        return readFile("promotions.json", new TypeReference<List<Promotion>>() {});
    }

    public void writePromotions(List<Promotion> promotions) throws IOException {
        writeFile("promotions.json", promotions);
    }
