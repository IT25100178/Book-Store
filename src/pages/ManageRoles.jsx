...
const INITIAL_STAFF = [
    { id: 1, name: 'Admin Avatar', email: 'admin@lankabooks.com', role: 'Super Admin', status: 'Active', joined: '2024-01-10' },
    { id: 2, name: 'John Editor', email: 'john@lankabooks.com', role: 'Content Editor', status: 'Active', joined: '2025-03-15' },
    { id: 3, name: 'Alice Orders', email: 'alice@lankabooks.com', role: 'Order Manager', status: 'Active', joined: '2025-07-01' },
    { id: 4, name: 'Sam Viewer', email: 'sam@lankabooks.com', role: 'Viewer', status: 'Inactive', joined: '2025-11-20' },
];
                    ...
                    <div className="modal" style={{ maxWidth: 480 }} onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            <div className="form-grid">
                                ...
                                <div className="form-group full">
                                    <label>Email *</label>
                                    <input className="form-control" type="email" placeholder="e.g. jane@lankabooks.com" value={form.email} onChange={e => setForm(f => ({ ...f, email: e.target.value }))} />
                                </div>
