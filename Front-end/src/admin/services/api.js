...
export const api = {
    ...
    // Promotions
    getPromotions: () => axios.get(`${BASE}/promotions`),
    addPromotion: (promotion) => axios.post(`${BASE}/promotions`, promotion),
    updatePromotion: (id, promotion) => axios.put(`${BASE}/promotions/${id}`, promotion),
    deletePromotion: (id) => axios.delete(`${BASE}/promotions/${id}`),

    // Reviews
    getReviews: () => axios.get(`${BASE}/reviews`),
    updateReview: (id, review) => axios.put(`${BASE}/reviews/${id}`, review),
    deleteReview: (id) => axios.delete(`${BASE}/reviews/${id}`),
