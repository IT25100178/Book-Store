                ...
                <div style={{ width: '320px', background: 'var(--bg-card)', borderRadius: '12px', border: '1px solid #E2E8F0', padding: '24px', height: 'fit-content', position: 'sticky', top: '0', boxShadow: '0 4px 20px rgba(0,0,0,0.06)' }}>
                    ...
                    <div>
                        ...
                        {authorBooks.length === 0
                            ...
                            : authorBooks.map(b => (
                                <div key={b.id} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '8px', borderRadius: '6px', border: '1px solid #F1F5F9', marginBottom: '6px', position: 'relative' }}>
                                            ...
                                            if (newDesc !== null) {
                                                api.updateBook(b.id, { ...b, description: newDesc })
                                                    .then(() => {
                                                        ...
                                                        api.getAuthorBooks(selectedAuthor.id).then(r => setAuthorBooks(r.data));
                                                    });
                                            }
                                        }}
                                    >
